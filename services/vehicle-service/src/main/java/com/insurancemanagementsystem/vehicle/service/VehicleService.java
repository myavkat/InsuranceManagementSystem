...
public class VehicleService {
	...
	public Page<VehicleResponse> findAll(Pageable pageable, String search, UUID customerId) {
		...
		java.util.Set<UUID> customerIds = vehiclePage.getContent()
			.stream()
	...
	public VehicleResponse create(VehicleRequest request) {
		...
		vehicleRepository.findByPlate(request.getPlate().trim()).ifPresent(v -> {
	...
	private VehicleResponse toResponse(Vehicle vehicle, String customerName) {
		...
		return VehicleResponse.fromEntity(vehicle, brand != null ? brand.getName() : null,
				model != null ? model.getName() : null, engine != null ? engine.getName() : null,
				engine != null ? engine.getVolume() : null, engine != null ? engine.getPower() : null,
				fuelType != null ? fuelType.getName() : null, type != null ? type.getName() : null,
				pkg != null ? pkg.getName() : null, customerName);
	}

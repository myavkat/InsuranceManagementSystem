 ...
 * BaseGatewayTest), which intercepts preflight requests at the WebFilter level
 * before SCG route matching. Actual response CORS headers come from downstream
 * services and are forwarded by the Gateway.
 */
    ...
    void actualResponseIncludesCorsHeaders() {
        wireMockServer.stubFor(
                com.github.tomakehurst.wiremock.client.WireMock.get(
                        com.github.tomakehurst.wiremock.client.WireMock.urlPathEqualTo("/reference-data/cities"))

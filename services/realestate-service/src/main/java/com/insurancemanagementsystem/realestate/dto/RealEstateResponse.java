...
public class RealEstateResponse {
	...
	public static RealEstateResponse fromEntity(RealEstate realEstate, String constructionTypeName,
			String luxuryClassName, String usageTypeName, String cityName, String customerName) {

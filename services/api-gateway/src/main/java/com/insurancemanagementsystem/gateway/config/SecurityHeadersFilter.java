...
/**
 * Adds security headers to all responses. Executed after route forwarding (response
 * phase) via post-filter.
 */
@Component
@Slf4j
public class SecurityHeadersFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		// (not new to Spring 7 / Boot 4), so post-filter header modification isn't
		// possible.

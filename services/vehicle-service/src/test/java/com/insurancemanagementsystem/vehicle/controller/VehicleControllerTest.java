...
class VehicleControllerTest {
	...
	void getAll_ReturnsPaginatedResponse() {
		...
		client.get()
			...
			.isArray()
			.jsonPath("$.data.content[0].plate")
			.isEqualTo("34 ABC 1234")
			.jsonPath("$.data.content[0].carBrandName")
			.isEqualTo("TestBrand");
	...
	void getById_NotFound_Returns404() {
		...
		client.get()
			...
			.isEqualTo(false)
			.jsonPath("$.message")
			.isEqualTo("Vehicle not found with id: " + testId);
	...
	void create_WithValidBody_Returns201() {
		...
		client.post()
			...
			.isEqualTo(true)
			.jsonPath("$.message")
			.isEqualTo("Vehicle created successfully")
			.jsonPath("$.data.plate")
			.isEqualTo("34 ABC 1234");
	...
	void update_Returns200() {
		...
		client.put()
			...
			.isEqualTo(true)
			.jsonPath("$.message")
			.isEqualTo("Vehicle updated successfully")
			.jsonPath("$.data.plate")
			.isEqualTo("34 ABC 5678");
	...
	void delete_Returns200() {
		client.delete()
			...
			.isEqualTo(true)
			.jsonPath("$.message")
			.isEqualTo("Vehicle deleted successfully");
	...
	void getModelsByBrand_ReturnsModelList() {
		...
		client.get()
			.uri("/api/vehicles/brands/{brandId}/models", 1)
			.exchange()
			.expectStatus()
			.isOk()
			.expectBody()

...
public class OpenAPIConfig {
	...
	public OpenAPI customOpenAPI() {
		...
		final String resolvedDescription = (description != null) ? description
				: "REST API for " + serviceName + ". This service is part of the Insurance Management System.";

		return new OpenAPI()
			.info(new Info().title(resolvedTitle)
				...
				.license(new License().name("Proprietary").url("https://insurancemanagementsystem.com/license")))
